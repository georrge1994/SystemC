...
${OBJECTDIR}/ALU.o: ALU.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ALU.o ALU.cpp
...
${OBJECTDIR}/Command_decoder.o: Command_decoder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Command_decoder.o Command_decoder.cpp

${OBJECTDIR}/Memory_controller.o: Memory_controller.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Memory_controller.o Memory_controller.cpp

${OBJECTDIR}/Top.o: Top.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Top.o Top.cpp

${OBJECTDIR}/Virtual_memory.o: Virtual_memory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Virtual_memory.o Virtual_memory.cpp

${OBJECTDIR}/io_module.o: io_module.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/io_module.o io_module.cpp
